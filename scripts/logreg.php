                ...
                if(mysqli_stmt_num_rows($stmt) == 1){
                    if (mysqli_stmt_fetch($stmt) == TRUE) {
                        if ($activated == 1) {
                            ...
                            $sql = 'UPDATE `users` SET `loggedIn`= 1, `airport` = ? WHERE `discord` = ?';
                            if($stmt = mysqli_prepare($link, $sql)){
                                
                                mysqli_stmt_bind_param($stmt, "ss", $param_airport, $param_username);

                                $param_airport = $_SESSION['Airport_ICAO'];
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){
                    ...
                    if($stmt = mysqli_prepare($link, $sql)){
                        ...
                        // Set parameters
                        $param_username = clean($_SESSION['Username']);
